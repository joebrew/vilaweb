...
Such a high level of talk about violence is clearly not a reflection of reality - there has been no notable increase in violence in recent months, and the much discussed acts of the last week in which pro-independence protestors blocked roadways is arguably illegal, but certainly not violent. No, rather, the high frequency of violence-related words is an _anticipatory_ violence, creating a mental frame primed to interpret the upcoming protests of December 21 as war-like.
...
```{r}
x = '' 
y = 'Percent with low lexical diversity'
