...
plot_compare(ca = FALSE, only_indepes = TRUE) +
  labs(title = 'How much PRO-INDY Catalans like inhabitants of\nother regions, and how much they like Catalans')
```
...
plot_compare(ca = T, only_indepes = TRUE) +
  labs(title = 'Grau de simpatia de catalans independentistes cap als\nhabitants de les altres comunitats autònomes i grau de\nsimpatia dels habitants de les altres comunitats\nautònomes cap a tots els catalans',
       subtitle = '(Valoració CAP a tots el catalans; valoració DE només catalans independentistes)')
```
