...
Estrella Durá Ferrandis Fernando Grande-Marlaska Iban García del Blanco Iratxe García Isabel García Muñoz Javier Moreno Sánchez José Guirao Margarita Robles María Luisa Carcedo Reyes Maroto

A total of 47 accounts were examined for the entirety of 2018-2019 (through August 15), resulting in a total of 44115 tweets. A tweet was classified as "being about Open Arms" if it contained any of the following:
...
Most Socialists did not mention Open Arms on Twitter either year. But among those that ever mentioned Open Arms on Twitter, rates were universally higher in 2018 than 2019:

![](figures/unnamed-chunk-5-1.png)

In other words, despite their enthusiasm for and solidarity with Open Arms' work in 2018, and despite the crew and rescued individuals of Open Arms spending the first two weeks of August in the Mediterranean with no port, Spanish and Catalan socialists were extremely silent on the topic.
...
Could it be that the 47 socialists examined feel that Open Arms, whose principles many of them enthusiastically applauded in 2018, has abandoned its principles? Could it be that they feel that the work that Open Arms is doing is wrong?
...
Data were gathered from twitter using the python `twint` package, and stored in a local database using the instructions in the set-up of the R `vilaweb` package (<https://github.com/joebrew/vilaweb>). The code for this analysis is publicly available [here](https://github.com/joebrew/vilaweb/tree/master/analyses/openarms).
