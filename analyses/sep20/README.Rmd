...
We harvested tweets and headlines for `r n_papers` Spanish newspapers. We intentionally restricted our analysis only to those newspapers with a known anti-independence editorial position, so as to increase the likelihood of finding a "signal" in the "noise". The newspapers are listed below:
...
_Newspaper headlines do not reflect the occurrence of an event as attention-worthy as a violent rebellion._
