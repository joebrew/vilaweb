...
simple_party_plot_cross(cross_var = 'informat', legend_title = 'Grau d\'informació política') +
  labs(subtitle = 'Grau d\'informació política per la política per partit',
       title = 'Es considera vostè molt, bastant, poc o gens informat/ada del que passa en política?') +
  theme(legend.title = element_text())
```
