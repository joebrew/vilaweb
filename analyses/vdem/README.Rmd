---
title: "No, V-Dem data does NOT show an improvement in democracy in Spain. In fact, Spain just received its worst score in 40 years."
...
make_plot <- function(ca = FALSE, start_year = 1979,
  ...
  if(ca){
    the_labs <- labs(x = 'Any',
                     ...
                     title = 'Espanya: Index de democràcia liberals segons el V-Dem',
...
make_plot_rank <- function(ca = FALSE, start_year = 1979,
  ...
  if(ca){
    the_labs <- labs(x = 'Any',
                     y = 'Ranking',
                     title = 'Ranking d\'Espanya: Index de democràcia liberals segons el V-Dem',
                     subtitle = 'Dades V-Dem, versió 9, publicades en maig 2019.',
                     caption = 'Dades V-Dem. https://www.v-dem.net/en/data/data-version-9/\nGràfic de Joe Brew | www.vilaweb.cat | @joethebrew.')
  } else {
    the_labs <- labs(x = 'Year',
...
_Sent by Joe Brew on May 24, 2019_
...
_Sent from Johannes von Römer, Senior Data Manager, V-Dem Institute, on May 27 2019_
...
Fourth, we strive for full coverage and therefore continuously add new countries and expand our time-series.
For each variable the input of our Bayesian Item Response Theory Measurement model contains the coder scores for that specific question across all countries and years (in reduced form, capturing changes only). 
...
For the case of the Liberal Democracy Index for Spain this means that while in v8 Spain was ranked 35 for v2x_libdem for the year 2017, in v9 Spain ranked 26 for the year 2017.
Spain could thus celebrate that they thought they were ranked at around 35 in the year 2017, but newer data suggests that they were actually ranked around 26 in 2017.
...
If the government employees as described by you compare v8 2017 scores with either v9 2018 or v9 2017 scores that would be very misleading in both cases due to the V-Dem methodology.
To clarify, the 2019 report uses v9 data (data until 2018) and the 2018 report uses v8 data (data until 2017). 
