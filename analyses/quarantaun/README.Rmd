...
# Model
fit <- glm(indepe == 'Sí' ~ llengua_primera + axis_super_simple , data = cosmo)
fit2 <- glm(indepe == 'No' ~ llengua_primera + axis_super_simple , data = cosmo)
fit3 <- glm(indepe == 'NS/NC' ~ llengua_primera + axis_super_simple , data = cosmo)
