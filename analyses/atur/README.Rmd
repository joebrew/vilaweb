...
bloomberg <- function(ca = FALSE,
  ...
  if(ca){
    ...
    the_labs <- labs(x = 'Data',
                     ...
                     caption = 'Dades del Centre d\'Estudis d\'Opinió CAT i el Instituto Nacional de Estadística ESP\nGràfic de Joe Brew | @joethebrew | www.vilaweb.cat.')
  } else {
    pd <- pd %>%
      mutate(key = ifelse(key == 'Un estat independent',
                          '% in favor of\nindependence',
...
charter <- function(ca = FALSE){
  ...
  #   ungroup
    ...
    the_labs <- labs(x = '',
                     ...
                     caption = 'Dades del Centre d\'Estudis d\'Opinió CAT i el Instituto Nacional de Estadística ESP\n\'No aturats\' inclou estudiants, jubilats, treballadors domèstics no remunerats.\nGràfic de Joe Brew | @joethebrew | www.vilaweb.cat.')
  } else {
    the_labs <- labs(x = '',
                     y = '%',
