...
make_plot <- function(ca = FALSE,
  ...
  if(ca){
    if(y == 'interactions'){
      the_title <- "'Interaccions' per dia"
    } else {
    ...
    the_labs <- labs(x = 'Dia',
                   y = 'Piulets',
                   title = the_title,
                   subtitle = 'Twitter. 1 de juny - 3 de juliol 2019',
                   caption = 'Joe Brew | @joethebrew | www.vilaweb.cat')
    
  } else {
    if(y == 'interactions'){
      the_title <- "'Interactions' per day"
    } else {
    ...
    the_labs <- labs(x = 'Day',
                   y = 'Tweets',
                   title = the_title,
                   subtitle = 'Twitter. June 1 - July 3 2019',
                   caption = 'Joe Brew | @joethebrew | www.vilaweb.cat')
  }
  agg$y <- unlist(agg[,y])
...
make_another <- function(ca = FALSE){
  ...
  if(ca){
    ...
    the_labs <- labs(x = '',
                     y = 'Interaccions',
                     title = 'Interaccions: 28 juny - 3 juliol 2019',
                     subtitle = '',
                     caption = 'Joe Brew | @joethebrew | www.vilaweb.cat')
  } else {
    the_labs <- labs(x = '',
                     y = 'Interactions',
                     title = 'Interactions: 28 June - 3 July 2019',
                     subtitle = '',
                     caption = 'Joe Brew | @joethebrew | www.vilaweb.cat')
  }
  ggplot(data = pd,
...
make_wiki_time_plot(people = article_people,
                    ...
                    the_scales = 'fixed') +
  geom_point() +
  labs(title = 'Daily Wikipedia page-views for Catalan politicians')  +
  theme(legend.text = element_text(size = 8),
        plot.title = element_text(size = 14))
```
...
make_wiki_plot(language = 'ca',
  ...
  labs(title = 'Visites de pàgines de Wikipedia',
       subtitle = '1 de juny - 3 de juliol de 2019')
```
